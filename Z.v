...
(* The free group [Z] on one generator is isomorphic to the subgroup of [Z] generated by the generator.  And such cyclic subgroups are known to be commutative. *)
Global Instance Z_commutative `{Funext} : Commutative (@group_sgop Z)
  := commutative_iso_commutative iso_subgroup_incl_freegroupon.

(* Can we avoid Funext anywhere? *)
